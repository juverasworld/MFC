...
//           <div className="presale-badge">🔥 Limited Time Offer</div>
//           <h2 className="presale-title">90-Day Presale</h2>
...
//             <img src={presaleImage} alt="Presale Book" className="main-image" />
//           </div>
//           <p className="presale-subtitle">30% Discount</p>
//           <button className="cta-button" onClick={() => openOverlay("presale")}>
//             Order Presale Now
//           </button>
//         </div>
